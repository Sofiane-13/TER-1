...
La spécification de test niveau modèle pour une architecture donnée permettrait un déploiement sûr des logiciels ou des services dans les entreprises en prenant en considération l'environnement dans le quelle ce dernier sera déployé.
