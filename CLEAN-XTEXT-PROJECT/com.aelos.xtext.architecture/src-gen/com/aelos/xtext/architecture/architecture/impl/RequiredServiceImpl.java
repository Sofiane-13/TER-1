 ...
 * </p>
 * <ul>
 *   <li>{@link com.aelos.xtext.architecture.architecture.impl.RequiredServiceImpl#getNameVarMethode <em>Name Var Methode</em>}</li>
 *   <li>{@link com.aelos.xtext.architecture.architecture.impl.RequiredServiceImpl#getNameComp <em>Name Comp</em>}</li>
 *   <li>{@link com.aelos.xtext.architecture.architecture.impl.RequiredServiceImpl#getNameServ <em>Name Serv</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredServiceImpl extends MinimalEObjectImpl.Container implements RequiredService
{
  ...
  {
    return ArchitecturePackage.Literals.REQUIRED_SERVICE;
  }
  ...
  public EList<Variable> getNameVarMethode()
  {
    ...
    {
      nameVarMethode = new EObjectContainmentEList<Variable>(Variable.class, this, ArchitecturePackage.REQUIRED_SERVICE__NAME_VAR_METHODE);
    }
  ...
  public EList<InstanceComp> getNameComp()
  {
    if (nameComp == null)
    {
      nameComp = new EObjectResolvingEList<InstanceComp>(InstanceComp.class, this, ArchitecturePackage.REQUIRED_SERVICE__NAME_COMP);
    }
    return nameComp;
  }
  ...
  public EList<ServiceName> getNameServ()
  {
    if (nameServ == null)
    {
      nameServ = new EObjectResolvingEList<ServiceName>(ServiceName.class, this, ArchitecturePackage.REQUIRED_SERVICE__NAME_SERV);
    }
    return nameServ;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArchitecturePackage.REQUIRED_SERVICE__NAME_VAR_METHODE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ArchitecturePackage.REQUIRED_SERVICE__NAME_COMP:
        return getNameComp();
      case ArchitecturePackage.REQUIRED_SERVICE__NAME_SERV:
        return getNameServ();
    }
