...
public class MappingAssistanceParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingAssistanceGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAbstractModelAccess().getTestDrAssignment_1_0(), "rule__AbstractModel__TestDrAssignment_1_0");
			builder.put(grammarAccess.getAbstractModelAccess().getObsAssignment_1_1(), "rule__AbstractModel__ObsAssignment_1_1");
			builder.put(grammarAccess.getAbstractModelAccess().getCompAssignment_1_2(), "rule__AbstractModel__CompAssignment_1_2");
			builder.put(grammarAccess.getAbstractModelAccess().getMockAssignment_1_3(), "rule__AbstractModel__MockAssignment_1_3");
			builder.put(grammarAccess.getAbstractModelAccess().getConfAssignment_1_4(), "rule__AbstractModel__ConfAssignment_1_4");
			builder.put(grammarAccess.getAbstractModelAccess().getBindAssignment_1_5(), "rule__AbstractModel__BindAssignment_1_5");
			builder.put(grammarAccess.getAbstractModelAccess().getInstAssignment_1_6(), "rule__AbstractModel__InstAssignment_1_6");
