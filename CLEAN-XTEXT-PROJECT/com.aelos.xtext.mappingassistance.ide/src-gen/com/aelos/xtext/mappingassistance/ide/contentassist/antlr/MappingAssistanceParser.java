...
public class MappingAssistanceParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingAssistanceGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTestDriverAccess().getGroup_3_6_1(), "rule__TestDriver__Group_3_6_1__0");
			...
			builder.put(grammarAccess.getTestDriverAccess().getVarConfAssignment_3_6_0_0(), "rule__TestDriver__VarConfAssignment_3_6_0_0");
			builder.put(grammarAccess.getTestDriverAccess().getInstVarAssignment_3_6_0_2(), "rule__TestDriver__InstVarAssignment_3_6_0_2");
			builder.put(grammarAccess.getTestDriverAccess().getVarConfAssignment_3_6_1_0(), "rule__TestDriver__VarConfAssignment_3_6_1_0");
			builder.put(grammarAccess.getTestDriverAccess().getInstVarAssignment_3_6_1_2(), "rule__TestDriver__InstVarAssignment_3_6_1_2");
