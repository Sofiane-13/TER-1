 ...
 *   <li>{@link com.aelos.xtext.mappingassistance.mappingAssistance.impl.InstanceCompImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceCompImpl extends MinimalEObjectImpl.Container implements InstanceComp
{
  ...
  public AddComponent getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingAssistancePackage.INSTANCE_COMP__TYPE, oldType, type));
      }
    }
    return type;
  }
