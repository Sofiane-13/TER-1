 ...
 * </p>
 * <ul>
 *   <li>{@link com.aelos.xtext.testintentionsassistance.testintentionsAssistance.impl.VariableRefImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableRefImpl extends ExpressionImpl implements VariableRef
{
  ...
  {
    return TestintentionsAssistancePackage.Literals.VARIABLE_REF;
  }
    ...
    if (variable != null && variable.eIsProxy())
    {
      ...
      if (variable != oldVariable)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestintentionsAssistancePackage.VARIABLE_REF__VARIABLE, oldVariable, variable));
      }
    }
    return variable;
  }
  ...
  public void setVariable(Variable newVariable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestintentionsAssistancePackage.VARIABLE_REF__VARIABLE, oldVariable, variable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TestintentionsAssistancePackage.VARIABLE_REF__VARIABLE:
